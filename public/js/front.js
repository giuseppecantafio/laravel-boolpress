  ...
  methods: {
    getDetail: function getDetail(slug, index) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("/api/posts/" + slug).then(function (response) {
        ...
        console.log(_this.posts[index].detail);
      });
    }
  },
...
var staticRenderFns = [
  function () {
    ...
    return _c("div", [
      _c("header", [
        _c("ul", { staticClass: "d-flex justify-content-center flex-end" }, [
          _c("li", [_c("a", { attrs: { href: "/" } }, [_vm._v("Home")])]),
          _vm._v(" "),
          _c("li", [
            _c("a", { staticClass: "px-4", attrs: { href: "/admin" } }, [
...
var render = function () {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("h1", [_vm._v("Ciao sono il main component")]),
    _vm._v(" "),
    _c(
      "ul",
